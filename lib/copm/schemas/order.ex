defmodule Copm.Schemas.Order do
  ...
  alias Copm.Schemas.{Client, User, TrackingEvent, Payment, Message}
  ...
  schema "orders" do
    ...
    has_many :tracking_events, TrackingEvent, foreign_key: :order_id
    has_many :payments, Payment, foreign_key: :order_id
    has_many :messages, Message, foreign_key: :related_order_id

    timestamps()
  end

  @required ~w(order_id contract_id client_id user_id order_status order_type created_at confirmed_at sender receiver route_from route_to carrier cargo_description cargo_weight cargo_danger_class estimated_delivery_date actual_delivery_date)a
